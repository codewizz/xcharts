(function () {
  ...
  function enter(self, storage, className, data, callbacks) {
    ...
    container.enter().insert('g', insertBefore)
      ...
      .attr('class', function (d, i) {
        var cl = _.uniq((className + (typeof d.className !== 'undefined' ? d.className : '')).split('.')).join(' ');
        return cl + ' line ' + _visutils.colorClass(this, typeof d.colorIndex !== 'undefined' ? Number(d.colorIndex) : i);
      });
  ...
  function update(self, storage, timing) {
    storage.lineContainers
      .attr('class', function (d, i) {
        return _visutils.colorClass(this, typeof d.colorIndex !== 'undefined' ? Number(d.colorIndex) : i);
      });
